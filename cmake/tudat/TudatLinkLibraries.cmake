...
if (TUDAT_BUILD_WITH_SOFA_INTERFACE)
    list(APPEND TUDAT_EXTERNAL_LIBRARIES Sofa::sofa)
...
list(APPEND TUDAT_EXTERNAL_INTERFACE_LIBRARIES nrlmsise_00::nrlmsise_00)

if(TUDAT_BUILD_WITH_FFTW3)
    list(APPEND TUDAT_EXTERNAL_INTERFACE_LIBRARIES FFTW3::fftw3)
endif( )

if (TUDAT_BUILD_WITH_JSON_INTERFACE)
    list(APPEND TUDAT_EXTERNAL_LIBRARIES nlohmann_json::nlohmann_json)
endif ()
